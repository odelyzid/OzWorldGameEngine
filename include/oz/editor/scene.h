...
// Map Operations
void editor_scene_add_box(EditorScene *scene, const OzVec3 *center,
                          const OzVec3 *half_extents);
void editor_scene_add_cylinder(EditorScene *scene, const OzVec3 *center,
                               float radius_x, float radius_y, float height,
                               int segments);
void editor_scene_add_sphere(EditorScene *scene, const OzVec3 *center,
                             float radius, int segments);
void editor_scene_add_pyramid(EditorScene *scene, const OzVec3 *center,
                              float width, float height, float depth);
void editor_scene_add_plane(EditorScene *scene, const OzVec3 *center,
                            const OzVec3 *normal, float size);
...
void editor_scene_move_object(EditorScene *scene, int object_index,
                              const OzVec3 *new_position);
...
void editor_scene_start_transform(EditorScene *scene, double screen_x,
                                  double screen_y);
void editor_scene_update_transform(EditorScene *scene, double screen_x,
                                   double screen_y, double start_x,
                                   double start_y);
...
int editor_scene_pick_brush(EditorScene *scene, float screen_x, float screen_y,
                            int viewport_w, int viewport_h);
int editor_scene_pick_object(EditorScene *scene, float screen_x, float screen_y,
                             int viewport_w, int viewport_h);
bool editor_scene_ray_intersect_brush(EditorScene *scene, int brush_index,
                                      const OzVec3 *ray_origin,
                                      const OzVec3 *ray_direction,
                                      float *out_distance);
