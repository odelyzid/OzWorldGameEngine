...
bool editor_input_is_key_pressed(EditorInput* input, enum OzKey key);  // Single frame press
bool editor_input_is_key_released(EditorInput* input, enum OzKey key); // Single frame release
